...
`Options` carrying `max_mem` and `log_errors`, the compiled regexp's `.search`,
and the re-compatible `error` compile-failure type. This is a stub on
`mypy_path`, not a runtime override; the real C++ binding is what executes.
"""
